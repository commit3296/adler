...
- Pinterest, Reddit, Instagram, and X / Twitter now have stable
  evidence-backed paths; Patreon is covered as a status-only route with
  guards against false exact-username evidence; continue hardening the
  remaining post-TikTok target set — Patreon stronger metadata and Threads —
